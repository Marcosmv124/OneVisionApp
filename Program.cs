...
// --- Autenticaci�n con cookies (predeterminada para MVC) y JWT (usado solo en API cuando se env�a el header)
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        Title = "OneVision API",
        Version = "v1",
        Description = "Documentaci�n de la API de One Vision Optical Center"
    });
});
