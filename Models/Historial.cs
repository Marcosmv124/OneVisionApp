...
namespace One_Vision.Models
{
    public class Historial
    {
        ...
        // Campos visuales (fragmento ejemplo)
        [StringLength(25)]
        public string AV_SC_OD_L { get; set; }

        [StringLength(25)]
        public string AV_SC_OL_L { get; set; }

        [StringLength(25)]
        public string AV_SC_OD_C { get; set; }

        [StringLength(25)]
        public string AV_SC_OL_C { get; set; }

        [StringLength(25)]
        public string AV_SC_OD_PH { get; set; }

        [StringLength(25)]
        public string AV_SC_OL_PH { get; set; }

        [StringLength(25)]
        public string AV_SC_AO_OD { get; set; }

        [StringLength(25)]
        public string AV_SC_AO_OL { get; set; }

        [StringLength(25)]
        public string AV_L_OD_ESF { get; set; }

        [StringLength(25)]
        public string AV_L_OL_ESF { get; set; }

        [StringLength(25)]
        public string AV_L_OD_CIL { get; set; }

        [StringLength(25)]
        public string AV_L_OL_CIL { get; set; }

        [StringLength(25)]
        public string AV_L_OD_EJE { get; set; }

        [StringLength(25)]
        public string AV_L_OL_EJE { get; set; }
